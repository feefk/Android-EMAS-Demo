...
public class MtopActivity extends Activity {
    ...
    /*** 请求参数配置 ***/
    private  String api = "emas.max.mock.check";//"mtop.bizmock.test.passbody.http";
    ...
    private void initDefaultRequest() {
        ...
        mtopBuilder.setCustomDomain(EmasInit.getInstance().mAPIDoman);
    ...
    private void initDialogView() {
        ...
        domainEt.setText(EmasInit.getInstance().mAPIDoman);
        queryMap.clear();
    ...
    private void setDialogListener() {
        ...
        confirmBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v1) {
                api = apiNameEt.getText().toString();
                v = apiVersionEt.getText().toString();
                MtopRequest mtopRequest = new MtopRequest();
